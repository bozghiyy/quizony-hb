...
var ADAPTER_NAME = 'INDEX';
var ADAPTER_CODE = 'index';
...
var IndexAdapter = function IndexAdapter() {
  let baseAdapter = new Adapter('index');
...
adaptermanager.registerBidAdapter(new IndexAdapter(), 'index', {
